...
3. Read only the smallest matching note set:
   - `~/.codex/knowledge/global/*` for shared cross-repo concepts
...
- Start with `global/INDEX.md` only when the task is clearly cross-repo.
