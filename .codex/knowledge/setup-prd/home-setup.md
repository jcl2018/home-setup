...
- Repo or umbrella-root work keeps a required tracking doc at `<scope>/.local-work/current.md`, read immediately after the nearest scope `AGENTS.md`.
...
- Future sessions can discover whether the active scope is a repo or umbrella root, then find the correct tracking doc and child-repo layout quickly.
