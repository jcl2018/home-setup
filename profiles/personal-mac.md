...
After upstream upgrades (currently gstack), run `/skill-status` to check version alignment. If mismatched, re-copy portable SKILL.md files into `skills/`, bump the version in `skills-catalog.json` under `upstreams`, and commit.
