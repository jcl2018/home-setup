...
check "traceability.md exists" "[ -f '$REPO_ROOT/docs/generated/traceability.md' ]"
check "skills-reference.md exists" "[ -f '$REPO_ROOT/docs/generated/skills-reference.md' ]"

# Test 2: Generated files have content
echo ""
echo "--- Test 2: Content ---"
check "traceability.md non-empty" "[ -s '$REPO_ROOT/docs/generated/traceability.md' ]"
check "skills-reference.md non-empty" "[ -s '$REPO_ROOT/docs/generated/skills-reference.md' ]"
check "traceability has Mermaid" "grep -q 'mermaid' '$REPO_ROOT/docs/generated/traceability.md'"
check "skills-reference has table" "grep -q '| Skill |' '$REPO_ROOT/docs/generated/skills-reference.md'"
...
echo "stale" >> "$REPO_ROOT/docs/generated/traceability.md"
